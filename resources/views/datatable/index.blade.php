    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="userForm" action="{{ route('forms.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-10 ">
                        ...
                        <table class="table-responsive ">
                            ...
                            <tr><td></td><td style="text-align: right "><a href="{{ route('forms.index') }}" class="btn btn-danger">OK</a> </td></tr>
                        </table>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        {{--        // {data: 'multi_select', name: 'multi_select'},--}}
        {{--        // {data: 'textarea', name: 'textarea'},--}}
        {{--        // {data: 'radio', name: 'radio'},--}}
        {{--        // {data: 'checkbox', name: 'checkbox'},--}}
        {{--        // {data: 'color', name: 'color'},--}}
        {{--        // {data: 'date', name: 'date'},--}}
        {{--        // {data: 'local_date', name: 'local_date'},--}}
        ...
        $('body').on('click', '#edit-user', function () {
            ...
            $.get('forms/'+user_id+'/edit', function (data) {
        ...
        $('body').on('click', '#show-user', function () {
            var user_id = $(this).data('id');
            $.get('forms/'+user_id, function (data) {
        ...
        $('body').on('click', '#delete-user', function () {
            ...
            $.ajax({
                type: "DELETE",
                url: "http://localhost/laravelpro/public/forms/"+user_id,
                data: {
                    "id": user_id,
                    "_token": token,
                },
